...
test("renames minute load results without changing completed days, attempts or errors", t => {
  ...
  db.exec(`INSERT INTO moex_iss_minute_candle_load_days VALUES
...
test("an unexpected destination conflict preserves both tables", t => {
  ...
  db.exec("INSERT INTO moex_iss_minute_candle_load_days VALUES ('CNYRUB_TOM','2026-09-15',NULL,'2026-09-21T10:00:00.000Z','Retry')");
