...
test("page headings retain their current labels when navigating without breadcrumbs", () => {
  ...
  for (const [route, selector, title] of [
    ...
    ["#market-pulse:data-management", "#marketPageTitle", "Data Management"],
    ...
    ["#trade-intake:contract", "#tradeContractPage h1", "Trade Message Contract"],
    ["#trade-intake:messages", "#tradeIntakeMessagesPage h1", "Trade Message Registry"],
