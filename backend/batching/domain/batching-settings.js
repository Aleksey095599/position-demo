...
const BATCHING_ALLOW_CROSS_TENOR_BATCHING_DEFAULT = false;
...
function normalizedAllowCrossTenorBatching(value) {
  if (value === undefined) {
    return BATCHING_ALLOW_CROSS_TENOR_BATCHING_DEFAULT;
  }

  if (typeof value !== "boolean") {
    throw settingsError(
      "INVALID_BATCHING_SETTINGS",
...
function batchingSettings(source = {}) {
