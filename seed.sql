...
VALUES
    ...
    ('pricing_rules_grid', 'position_management_mode', 'FX Position Mode', 5, 232, 232),
    ...
    ('internal_pricing_rules_grid', 'position_management_mode', 'FX Position Mode', 5, 232, 232),
    ...
    ('batching_history_grid', 'batching_key', 'Batching Key', 2, 450, 450),
    ('batching_history_grid', 'window_opened_at', 'Window Opened At', 3, 157, 157),
    ('batching_history_grid', 'window_closed_at', 'Window Closed At', 4, 157, 157),
    ('batching_history_grid', 'window_duration_ms', 'Duration', 5, 105, 105),
    ('batching_history_grid', 'batch_status', 'Batch Status', 6, 101, 101),
    ('batching_history_grid', 'formation_reason_code', 'Formation Reason', 7, 252, 252),
    ('batching_history_grid', 'formed_at', 'Formed At', 8, 157, 157),
    ('batching_history_grid', 'source_trade_count', 'Source Trades', 9, 108, 108),
