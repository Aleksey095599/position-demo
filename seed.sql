...
VALUES
    ...
    ('pricing_rules_grid', 'ccy_pair', 'Ccy Pair', 3, 88, 88),
    ('pricing_rules_grid', 'execution_context', 'Execution Context', 4, 596, 596),
    ...
    ('internal_pricing_rules_grid', 'ccy_pair', 'Ccy Pair', 3, 88, 88),
    ('internal_pricing_rules_grid', 'execution_context', 'Execution Context', 4, 596, 596),
